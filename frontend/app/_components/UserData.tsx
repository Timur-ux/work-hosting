...
import { workType, workNumber, gvName } from "../_reducers/userData";

const UserData = () => {
  const dispatch = useAppDispatch()();
  const itemClass = "mx-5 my-2 text-center";
        ...
        <div className="content-center">
          ...
          <div className={itemClass}>
            <select
              ...
              defaultValue={"Unset"}
              onChange={(e) => dispatch(workType(e.target.value))}
            >
              <option>LR</option>
              <option>KP</option>
        ...
        <div className="content-center">
          ...
          <div className={itemClass}>
            <input
              type="number"
              className={fieldClass}
              onChange={(e) => dispatch(workNumber(e.target.value))}
            />
          </div>
        </div>
        <div className="content-center">
